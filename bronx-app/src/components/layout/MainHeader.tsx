...
interface MainHeaderProps {
    onLogout: () => void;
    userRole: 'socio' | 'guest';
}

export const MainHeader: React.FC<MainHeaderProps> = ({ onLogout, userRole }) => {
    return (
            ...
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center space-x-8">
                    ...
                    <nav className="hidden md:flex items-center space-x-6 border-l border-white/10 pl-8">
                        <button className="text-[10px] uppercase tracking-[0.3em] text-orange-500 font-bold">Catalog</button>
                ...
                <div className="flex items-center space-x-6">
                    ...
                    <div className="hidden sm:flex items-center space-x-2 px-3 py-1 bg-white/[0.03] border border-white/5 rounded-sm">
                        <div className={`w-1.5 h-1.5 rounded-full ${userRole === 'socio' ? 'bg-orange-500 animate-pulse' : 'bg-neutral-500'}`} />
                        <span className="text-[9px] uppercase tracking-widest text-neutral-400 font-mono">
                            {userRole === 'socio' ? 'Authorized_Socio' : 'Guest_Protocol'}
                        </span>
                    </div>
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-3 pl-2 group cursor-pointer">
                            <div className="text-right hidden xs:block">
                                ...
                                <p className="text-[10px] font-bold text-white uppercase tracking-wider">{userRole === 'socio' ? 'M. Allegri' : 'Guest_821'}</p>
                            </div>
